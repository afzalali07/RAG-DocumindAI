...
def offline_chat_provider(monkeypatch):
    """Tests use a fake; production always uses the configured Ollama model."""
    from app.api.routes import chat
    from fake_provider import MockProvider
    monkeypatch.setattr(chat, "get_provider", lambda _: MockProvider())
