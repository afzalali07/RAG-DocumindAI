"""Backend settings. OLLAMA_MODEL selects the local chat model at startup."""
...
class Settings(BaseSettings):
    ...
    # Optional key for embeddings only; chat always runs locally.
    openai_api_key: str | None = None
    ollama_base_url: str = "http://localhost:11434"
    ollama_model: Literal["llama3.2:3b", "llama3.1:8b"] = "llama3.2:3b"
