            ...
            >
              <div className="source-top">
                ...
                <span className="source-meta">
                  {s.page != null && (
                    <span className="source-page">{s.label || (s.filename.toLowerCase().endsWith('.pdf') ? t('page', { n: s.page }) : `${s.location_kind || (s.filename.toLowerCase().endsWith('.xlsx') ? 'Sheet' : 'Section')} ${s.page}`)}</span>
                  )}
                  {s.score != null && (
